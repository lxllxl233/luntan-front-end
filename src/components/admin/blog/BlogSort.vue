        ...
        methods: {
          ...
          submitV1(){
            this.$prompt('请输入要添加的一级分类名称', '提示', {
              ...
              this.$http.get("/api/admin/addBlogCatalogV1?name="+value).then(
                (response)=>{
                  this.refresh()
                },(err)=>{
                  console.log(err)
          ...
          submitV2(){
            ...
            this.$prompt('请输入要添加的二级分类名称', '提示', {
              ...
              this.$http.get("/api/admin/addBlogCatalogV2?name="+value+"&v1Id="+this.currentV1).then(
                (response)=>{
                  this.$message("添加成功")
                  this.refresh()
                },(err)=>{
          ...
          deleteV1(v1Id){
            this.$http.get("/api/admin/deleteBlogCatalogV1?id="+v1Id).then(
              (response)=>{
                this.refresh()
                this.$message("删除成功")
              },(err)=>{
          ...
          deleteV2(v2Id){
            this.$http.get("/api/admin/deleteBlogCatalogV2?id="+v2Id).then(
              (response)=>{
                this.refresh()
                this.$message("删除成功")
              },(err)=>{
